...
readonly GIT_AUTHOR="312022151125"
...
# Build flags
readonly LDFLAGS="-X 'github.com/312022151125/go-backend-template/internal/conf.Version=${GIT_VERSION}' \
                  -X 'github.com/312022151125/go-backend-template/internal/conf.BuildTime=${BUILD_TIME}' \
                  -X 'github.com/312022151125/go-backend-template/internal/conf.Author=${GIT_AUTHOR}' \
                  -X 'github.com/312022151125/go-backend-template/internal/conf.Commit=${COMMIT_ID}' \
                  -s -w"
